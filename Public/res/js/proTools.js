...
WebSlider.prototype = {
    ...
    slideToCurrent: function () {
        ...
        } else if (totalMove < -0.5 || totalMoveTime < 300 && totalMove < 0) {
        ...
        this.slideTimer = setTimeout(function () {
            _this.sliding = false;
            if (_this.currentIndex >= _this.itemLength * 2 - 1) {
...
DatePlugn.prototype = {
    ...
    bindEvent: function () {
        ...
        this.$input.on('keyup', function () {
            ...
            _this.inputCallBack && _this.inputCallBack($(this).val());
        });
        ...
        this.$addBtn.on('touchstart', function () {
            ...
            _this.inputCallBack && _this.inputCallBack(_this.currentDay);
        });
